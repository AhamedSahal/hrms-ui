...
export { default as loginbg } from '../assets/img/loginbg.png';
export { default as loginLogo } from '../assets/img/hcmlogo.png';
...
export { default as PlainBg } from '../assets/img/social-post-bg.png';
export { default as quickActionIcon } from '../assets/img/feed-icon.svg';
export { default as StarMedal } from '../assets/img/StarMedal.png';
export { default as socialmediapost } from '../assets/img/social-media.png';
export { default as leaveapplied } from '../assets/img/leave-applied.png';
export { default as leaveapproved } from '../assets/img/leave-approved.png';
export { default as leavecancelled } from '../assets/img/leave-cancelled.png';
export { default as reem } from '../assets/img/Reem.jpg';
export { default as nelson } from '../assets/img/Nelson.jpg';
export { default as elvira } from '../assets/img/Elvira.jpg'; 
export { default as appleIcon } from '../assets/img/App-Store.png'; 
export { default as googlePlay } from '../assets/img/google-play.png'; 
export { default as topBG } from '../assets/img/banner.png'; 