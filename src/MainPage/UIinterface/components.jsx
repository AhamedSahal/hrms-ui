...
class UIComponents extends Component {
   ...
   render() {
    ...
    return (
         <div >
            <Helmet>
               <title>Components - WorkPlus</title>
          ...
          <div className="header">
            ...
            <div className="header-left">
              <a href="/app/main/dashboard" className="logo">
                <img src={headerlogo} alt="WorkPlus" />
              </a>
            </div>
            {/* /Logo */}
            {/* Header Title */}
            ...
            <ul className="nav user-menu">
              ...
              <li className="nav-item dropdown has-arrow main-drop">
                ...
                <div className="dropdown-menu">
                  ...
                  <a className="dropdown-item" href="/settings/companysetting">Settings</a>
              ...
              <section className="comp-section comp-buttons" id="comp_buttons">
                ...
                <div>
                  ...
                  <p>
                    ...
                    <button type="button" className="btn btn-success btn-sm mr-1">Warning</button>
