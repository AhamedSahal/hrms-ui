...
import { getTasksList, updateStatus } from './service';
...
export default class Tasks extends Component {
    ...
    fetchList = () => {
            getTasksList(this.state.q, this.state.page, this.state.size, this.state.sort, this.state.statusname, this.state.statname).then(res => {
                if (res.status == "OK") {
                    this.setState({
                        data: res.data.list,
    ...
    render() {
        const { data, totalRecords, currentPage, size, TasksView } = this.state
                ...
                <div className="page-container content container-fluid">
                    ...
                    <div className="tablePage-header">
                        <div className="row pageTitle-section">
                            <div className="col">
                                <h3 className="tablePage-title">Task created by me</h3>
                            </div>
