...
import {  getRecognitionList } from './service';
...
export default class RecognitionMainList extends Component{
    constructor(props) {
      ...
      fetchList = () => {
         getRecognitionList(this.state.q, this.state.page, this.state.size, this.state.sort).then(res => {
    ...
    render() {
        ...
        return( 
            <div className="page-wrapper">
              <Helmet>
                <title>Recognition  | {getTitle()}</title>
                <meta name="description" content="Recognitione page" />
              </Helmet>
              {/* /Page Content */}
               ...
               {/* /Page Header */}
                <div className="page-header">
                  <div className="row align-items-center">
                    <div className="col">
                      <h3 className="page-title">Recognition</h3>
                      <ul className="breadcrumb">
                        <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                        <li className="breadcrumb-item active">Recognition</li>
                      </ul>
                    </div>
                  </div>
                </div>
