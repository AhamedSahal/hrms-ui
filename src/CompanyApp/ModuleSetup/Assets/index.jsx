...
import {  getAssetsList } from './service';
import { getTitle, verifyOrgLevelEditPermission, verifyOrgLevelViewPermission } from '../../../utility';
import AssetsSetupForm from './form';
import AccessDenied from '../../../MainPage/Main/Dashboard/AccessDenied';
const { Header, Body, Footer, Dialog } = Modal;
export default class AssetsSetup extends Component {
  constructor(props) {
    super(props);
  ...
  fetchList = () => {
    ...
    getAssetsList(this.state.q, this.state.page, this.state.size, this.state.sort).then(res => {
  ...
  updateList = (AssetsSetup) => {
    let { data } = this.state;
    let index = data.findIndex(d => d.id == AssetsSetup.id);
    if (index > -1)
      data[index] = AssetsSetup;
    else {
      data = [AssetsSetup, ...data];
    }
    this.setState({ data },
      () => {
        this.hideForm();
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render :(text,record) => {
            return <>
            <div>{record.assetCategory?.name} </div>
        </>
        },
        sorter: true,
      },
          ...
          <div className="dropdow">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              <a className="dropdown-item" href="#" onClick={() => {
                this.setState({ AssetsSetup: text, showForm: true })
              }} >
    ...
    return (
      <>
        <div className="page-container content container-fluid">
          ...
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Assets</h3>
              </div>
              <div className="float-right col-auto mt-2">
                ...
                {verifyOrgLevelEditPermission("Module Setup Manage") && <>
                  ...
                  }}><i className="fa fa-plus" /> Add Asset setup</a></>}
        ...
        <Modal enforceFocus={false} size={"md"} show={this.state.showForm} onHide={this.hideForm} >
          ...
          <Header closeButton>
            <h5 className="modal-title">{this.state.AssetsSetup ? 'Edit' : 'Add'} Asset </h5>

          </Header>
          <Body>
            <AssetsSetupForm updateList={this.updateList} AssetsSetup={this.state.AssetsSetup}>
            </AssetsSetupForm>
          </Body>
