...
import { getApplicantList, deleteApplicant } from "./service";
...
export default class ApplicantField extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  delete = (res) => {
    confirmAlert({
      title: `Delete Applicant ${res.fieldName}`,
      message: "Are you sure, you want to delete this Applicant Field?",
      buttons: [
        {
          label: "Yes",
          onClick: () =>
            deleteApplicant(res.id).then((res) => {
              if (res.status == "OK") {
          ...
          return (
            ...
            >
              {text.required ? (
                ...
                <i className="pr-2 fa fa-remove text-danger"></i>
              )}
            ...
            <>
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <a
                  ...
                  href="#"
                  onClick={() => {
                    this.setState({ applicant: text, showForm: true });
                  }}
                >
      ...
      <div className="page-container content container-fluid">
        ...
        <div className="tablePage-header">
          <div className="row pageTitle-section">
            <div className="col">
              <h3 className="tablePage-title">Applicant Field</h3>
            </div>
        ...
        >
          <Header closeButton>
            <h5 className="modal-title">Applicant Field</h5>
          </Header>
          <Body>
            <ApplicantForm applicant={this.state.applicant} updateData={this.updateData}></ApplicantForm>
          </Body>
        </Modal>
      </div>
    );
