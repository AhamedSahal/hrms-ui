...
import {getSystemFieldList} from './service'
import SystemForm from './form'
import {deleteCustomField} from './service'
import AccessDenied from "../../../MainPage/Main/Dashboard/AccessDenied";
import { verifyOrgLevelEditPermission, verifyOrgLevelViewPermission } from "../../../utility";
const { Header, Body, Footer, Dialog } = Modal;


export default class SystemField extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
 ...
 fetchList = () => { 
  if(verifyOrgLevelViewPermission("Module Setup Hire")){
    getSystemFieldList(this.state.q, this.state.page, this.state.size, this.state.sort).then(res => {
      if (res.status == "OK") {
        this.setState({
          data: res.data.list,
    ...
    delete = (res) => {
    confirmAlert({
      title: `Delete System Field ${res.name}`,
      message: 'Are you sure, you want to delete this System Field?',
      buttons: [
        {
          label: 'Yes',
        ...
        <div className="dropdow">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <a className="dropdown-item" href="#" onClick={() => {
              this.setState({ system: text, showForm: true })
            }} >
    ...
    return(
        ...
        <div className="tablePage-header">
          <div className="row pageTitle-section">
            <div className="col">
              <h3 className="tablePage-title">System Field</h3>
            </div>

            <div className="mt-2 float-right col-auto ml-auto">
            {verifyOrgLevelEditPermission("Module Setup Hire") &&
              <a
                href="#"
        ...
        <Header closeButton>
        <h5 className="modal-title"> System Field</h5>
        </Header>
        <Body>
          <SystemForm system = {this.state.system} updateData={this.updateData}></SystemForm>
        </Body>
        </Modal>
        </div>
    )
