...
export default class Activity extends Component {
  ...
  updateList = (activity) => {
    let { data } = this.state;
    let index = data.findIndex(d => d.id == activity.id);
    if (index > -1)
      data[index] = activity;
    else {
      data = [activity, ...data];
            ...
            {verifyOrgLevelEditPermission("Module Setup Plan") && <><a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <a className="dropdown-item" href="#" onClick={() => {
                  this.setState({ activity: text, showForm: true })
                }} >
        ...
        <div className="page-container content container-fluid">
          ...
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Activities</h3>
              </div>

              <div className="mt-2 float-right col-auto ml-auto">
                {verifyOrgLevelEditPermission("Module Setup Plan") && <a className="btn apply-button btn-primary" onClick={() => {
                  this.setState({
                    showForm: true
                  })
            ...
            <div className="col-md-12">
              <div className="mt-3 mb-3 table-responsive">
                ...
                {verifyOrgLevelViewPermission("Module Setup Plan") && <Table id='Table-style' className="table-striped "
                  ...
                  style={{ overflowX: 'auto', borderRadius: '11px' }}
                  columns={columns}
                  // bordered
                  dataSource={[...data]}
          ...
          <Modal enforceFocus={false} size={"md"} show={this.state.showForm} onHide={this.hideForm} >
            <Header closeButton>
              <h5 className="modal-title">{this.state.activity ? 'Edit' : 'Add'} Activity</h5>
            </Header>
            <Body>
              <ActivityForm updateList={this.updateList} activity={this.state.activity}>
              </ActivityForm>
            </Body>
          </Modal>
          </div>
