...
import PayVarianceReport from './Custom';
import PayVarianceDetailReport from './DetailReport';
import PayVarianceStatusReport from './TypeReport';


const { Header, Body, Footer, Dialog } = Modal;


export default class PayVarianceReportLanding extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        let {payVarianceReport} = this.state;
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                <div className="col-sm-4 col-md-4" style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    ...
                    <select className="form-control" defaultValue={this.state.closeYear}
                        onChange={e => {
                            this.setState({ payVarianceReport: e.target.value })
                        }}>
                ...
                {payVarianceReport == 1 && <PayVarianceDetailReport></PayVarianceDetailReport>}
                {payVarianceReport == 2 && <PayVarianceStatusReport></PayVarianceStatusReport>} 
                {payVarianceReport == 3 && <PayVarianceReport></PayVarianceReport>}
            </div>
            </div>
        );
    }
