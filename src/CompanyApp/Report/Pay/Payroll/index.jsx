...
import PayrollReport from './Custom';
import PayrollStatusReport from './Status';

const { Header, Body, Footer, Dialog } = Modal;


export default class PayrollReportLanding extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                {/* {payrollReport == 1 && <TaskSummaryReport></TaskSummaryReport>} */}
                {payrollReport == 1 && <PayrollStatusReport></PayrollStatusReport>} 
                {payrollReport == 2 && <PayrollReport></PayrollReport>}
            </div>
            </div>
        );
    }
