...
import { camelize, exportToCsv, getTitle,verifyViewPermission,setAllChecked, exportToCsvSorted,setAllCheckedEmployee, getMultiEntityCompanies, getCompanyId } from '../../../../../utility';
import BranchDropdown from '../../../../ModuleSetup/Dropdown/BranchDropdown';
import DepartmentDropdown from '../../../../ModuleSetup/Dropdown/DepartmentDropdown';
import PdfDocument from '../../../pdfDocument';
import { getPayrollReport } from '../../service';
...
export default class PayrollReport extends Component {
  ...
  super(props); 
    ...
    this.state = {
      ...
      sortedProperties:[],
      selectedPropertiestemp:["employeeId", "email", "fullName","departmentName","entityName","visaEntity","buCc","salaryCalculationMode","salaryMonth","totalDays","daysWorked","paidLeaves","unPaidLeaves","earningAmount","deductionAmount","totalEarning","netPaybleAmount"],
  ...
  fetchData = () => {
    ...
    getOrgSettings().then(res => {
     if (res.status == "OK") {
       ...
       if(res.data.entity){
         let tempProperties = ["employeeId", "email", "fullName","departmentName","entityName","visaEntity","buCc","salaryCalculationMode","salaryMonth","totalDays","daysWorked","paidLeaves","unPaidLeaves","earningAmount","deductionAmount","totalEarning","netPaybleAmount"];
  ...
  fetchList = () => {
    ...
    getPayrollReport(this.state.branchId, this.state.departmentId, this.state.jobTitleId,this.state.entityId, this.state.q, this.state.fromDate, this.state.toDate,this.state.selectedCompanies).then(response => {
      let data = response.data;
      this.setState({
        data
      }, () => {
        let sortedData = setAllCheckedEmployee(data,this.state.selectedPropertiestemp,true);
        ...
        <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Payroll Report</h3>
          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-md-3">
              <div className="form-group form-focus">
                <DepartmentDropdown  readOnly ={!this.state.isFilter} defaultValue={this.state.departmentId} companyId ={this.state.companyId} onChange={e => {
                  this.setState({
            ...
            <div className="col-sm-6 col-md-3">
              <div className="form-group form-focus">
              <JobTitlesDropdown  readOnly ={!this.state.isFilter} defaultValue={this.state.jobTitleId}  companyId={this.state.companyId} onChange={e => {
                          this.setState({
                ...
                {selectedData && selectedData.length > 0 &&
                  <ButtonGroup>
                    ...
                    <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                      exportToCsvSorted(selectedData, selectedProperties,"Payroll","Payroll")
                    }}>
