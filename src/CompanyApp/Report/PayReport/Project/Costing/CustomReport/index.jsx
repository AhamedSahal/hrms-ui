...
export default class CostingReport extends Component {
  ...
  super(props); 
    ...
    this.state = {
      ...
      sortedProperties:[],
      selectedPropertiestemp:["employeeId", "fullName","email","code","name","timesheetDate","department","location","hours","projectTotalCost","projectTotalCost","salaryPerDay","projectCostRemains","activityCostRemains","accuredBudgetCost","accuredActivityCost","projectActivityCost"],
  ...
  fetchList = () => {
    if(verifyViewPermission("Project Report")){
        getCostingReport(this.state.branchId, this.state.departmentId, this.state.jobTitleId, this.state.q, this.state.fromDate, this.state.toDate,this.state.selectedCompanies).then(response => {
        ...
        <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Costing Report</h3>
                <ul hidden className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                  <li className="breadcrumb-item">Report</li>
                  <li className="breadcrumb-item active">Costing Report</li>
                </ul>
              </div>
            </div>
          </div>
