...
import { camelize, exportToCsv, getTitle,toLocalTime,verifyViewPermission,setAllChecked, getMultiEntityCompanies, getCompanyId } from '../../../../../../utility';
import BranchDropdown from '../../../../../ModuleSetup/Dropdown/BranchDropdown';
import DepartmentDropdown from '../../../../../ModuleSetup/Dropdown/DepartmentDropdown';
import PdfDocument from '../../../../pdfDocument';
import { getRequisitionReport } from '../service';
...
export default class RequisitionReport extends Component {
  constructor(props) {
  super(props); 
    var today = new Date();
    ...
    this.state = {
      ...
      sortedProperties:[],
      selectedPropertiestemp:["jobTitle","department","resourceType","positionType","requisitionType","noOfMonths","noOfResources","requisitionInitiatedDate", "requisitionStartDate","reasonForRecruitment","initiatedBy","requisitionStatus"],
  ...
  fetchList = () => { 
    if(verifyViewPermission("WorkForce Plan Report")){
        getRequisitionReport(this.state.branchId, this.state.departmentId, this.state.jobTitleId, this.state.q, this.state.fromDate, this.state.toDate,this.state.selectedCompanies).then(response => {
  ...
  render() {
    ...
    return (
      <div className="insidePageDiv">
        <Helmet>
          <title>Requisition | {getTitle()}</title>
        ...
        <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Requisition Report</h3>
                <ul hidden className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                  <li className="breadcrumb-item">Report</li>
                  <li className="breadcrumb-item active">Requisition Report</li>
                </ul>
              </div>
            </div>
          </div>
                ...
                {selectedData && selectedData.length > 0 &&
                  <ButtonGroup>
                    ...
                    <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                      exportToCsv(selectedData,"Requisition","Requisition")
                    }}>
