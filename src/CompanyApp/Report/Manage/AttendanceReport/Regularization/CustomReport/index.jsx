...
import { getRegularizationReport } from '../service';
...
export default class RegularizationCustomReport extends Component {
  constructor(props) {
  super(props); 
    var today = new Date();
    ...
    this.state = {
      ...
      jobTitleId: "",
      selectedProperties: [],
      sortedProperties: ["employeeId", "fullName","email", "date","assignedShift","systemReason","recordedClockInTime","recordedClockOutTime","requestedClockInTime","requestedClockOutTime","reasonForRegularization","requestSubmissionStatus","approvalStatus","approver","submittedBy","submittedOn"],
        ...
        <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Regularization Custom Report</h3>
                <ul hidden className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                  <li className="breadcrumb-item">Report</li>
                  <li className="breadcrumb-item active">Regularization Custom Report</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className='row'>
                {data && data.length > 0 && this.state.sortedProperties.map((a, i) => {
                ...
                {selectedData && selectedData.length > 0 &&
                  <ButtonGroup>
                    ...
                    <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                      exportToCsv(selectedData,"RegularizationCustom","RegularizationCustom")
                    }}>
