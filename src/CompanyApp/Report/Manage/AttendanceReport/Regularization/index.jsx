...
import RegularizationCustomReport from './CustomReport';
import RegularizationStatusReport from './StatusReport';
import RegularizationDetailReport from './DetailReport';
import moment from "moment";
const { Header, Body, Footer, Dialog } = Modal;


export default class RegularizationReportLanding extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                {attendanceReport == 1 && <RegularizationDetailReport></RegularizationDetailReport>}
                {attendanceReport == 2 && <RegularizationStatusReport></RegularizationStatusReport>} 
                {attendanceReport == 3 && <RegularizationCustomReport></RegularizationCustomReport>}
            </div>
            </div>
        );
    }
