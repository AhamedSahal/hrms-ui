...
import LeaveReport from './CustomReport';
import LeaveDataReport from './DetailReport';
import LeaveBalanceReport from './BalanceReport';
const { Header, Body, Footer, Dialog } = Modal;


export default class LeaveReportLanding extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                <div className="col-sm-4 col-md-4" style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    ...
                    <select className="form-control" defaultValue={this.state.closeYear}
                        onChange={e => {
                            this.setState({ leaveReport: e.target.value })
                        }}>
                ...
                <div className='mt-3'>
                 ...
                 {leaveReport == 1 && <LeaveDataReport></LeaveDataReport>}
                 {/* {leaveReport == 2 && <AttendanceLateReport></AttendanceLateReport>}  */}
                 {leaveReport == 2 && <LeaveBalanceReport></LeaveBalanceReport>}
                {leaveReport == 3 && <LeaveReport></LeaveReport>}
            </div>
            </div>
        );
    }
