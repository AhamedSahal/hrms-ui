...
export default class AttendanceReport extends Component {
  ...
  super(props); 
    ...
    this.state = {
      ...
      designationId: "",
      jobTitleId: "",
      selectedPropertiestemp : ["employeeId", "fullName","email", "date","settingClockIn","settingClockOut","actualClockIn","actualClockOut","planedHours","actualHours","overTime","approvedHours","approver","overTimeApprovalStatus"],
      selectedProperties: [],
                ...
                {selectedData && selectedData.length > 0 &&
                  <ButtonGroup>
                    ...
                    <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                      exportToCsv(selectedData,"AttendanceCustom","AttendanceCustom")
                    }}>
