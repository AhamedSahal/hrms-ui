...
import { getTimesheetReport } from '../service';
...
export default class TimesheetReport extends Component {
  ...
  super(props); 
    ...
    this.state = {
      ...
      sortedProperties:[],
      selectedPropertiestemp:["employeeId", "fullName", "email","date","project","activity","planedHours","actualHours","approvedHours","overTime","approver","overTimeApprovalStatus"],
  ...
  fetchList = () => {
    ...
    getTimesheetReport(this.state.branchId, this.state.departmentId, this.state.jobTitleId, this.state.q, this.state.fromDate, this.state.toDate,this.state.selectedCompanies).then(response => {
        ...
        <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Timesheet Report</h3>
                <ul hidden className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                  <li className="breadcrumb-item">Report</li>
                  <li className="breadcrumb-item active">Timesheet Report</li>
                </ul>
              </div>
            </div>
          </div>
                ...
                {selectedData && selectedData.length > 0 &&
                  <ButtonGroup>
                    ...
                    <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                      exportToCsv(selectedData,"Timesheet","Timesheet")
                    }}>
