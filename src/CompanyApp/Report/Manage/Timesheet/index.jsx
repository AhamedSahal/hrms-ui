...
import TimesheetReport from './CustomReport';
import TimesheetDataReport from './DetailReport';
import TimesheetStatusReport from './StatusReport';
const { Header, Body, Footer, Dialog } = Modal;


export default class TimeSheetReportLanding extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        let {timeSheetReport} = this.state;
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                <div className="col-sm-4 col-md-4" style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    ...
                    <select className="form-control" defaultValue={this.state.closeYear}
                        onChange={e => {
                            this.setState({ timeSheetReport: e.target.value })
                        }}>
                ...
                {timeSheetReport == 1 && <TimesheetDataReport></TimesheetDataReport>}
                {timeSheetReport == 2 && <TimesheetStatusReport></TimesheetStatusReport>}
                {timeSheetReport == 3 && <TimesheetReport></TimesheetReport>}
            </div>
            </div>
        );
    }
