...
import { camelize,exportToCsv, getCompanyId, getMultiEntityCompanies, getTitle, toLocalTime, verifyViewPermission } from '../../../../../utility';
// import PdfDocument from '../../../pdfDocument';
import PdfDocument from '../../../pdfDocument';
import { getTaskStatusReport } from '../service';
...
export default class TaskStatusReport extends Component {
  constructor(props) {
    super(props);
    var today = new Date();
  ...
  fetchList = () => {
    if (verifyViewPermission("Task Report")) {
        getTaskStatusReport(this.state.q, this.state.fromDate, this.state.toDate > this.state.currentDate?this.state.currentDate:this.state.toDate,this.state.taskStatus,this.state.selectedCompanies).then(response => {
  ...
  setAllChecked = (checkAll) => {
    ...
    let sortedData = [];
    let selectedProperties = ["employeeId","fullName","email","taskName","url","status","fileName","description","startDate","endDate","completedDate"];
        ...
        <div className="page-containerDocList content container-fluid" style={{ marginTop: "20px" }}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Task Status Report</h3>
                <ul hidden className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                  <li className="breadcrumb-item">Report</li>
                  <li className="breadcrumb-item active">Task Status Report</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="col-sm-6 col-md-5">
              <div className="form-group form-focus">
                  <select
                    ...
                    defaultValue={this.state.taskStatus}
                    onChange={(e) => {
                  ...
                  {selectedData && selectedData.length > 0 &&
                    <ButtonGroup>
                      <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                        exportToCsv(selectedData, "TaskStatus", "TaskStatus")
                      }}>
