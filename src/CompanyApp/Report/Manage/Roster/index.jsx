...
import RosterReport from './Custom';
import RosterDetailReport from './DetailReport';
const { Header, Body, Footer, Dialog } = Modal;


export default class RosterReportLanding extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                <div className="col-sm-4 col-md-4" style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    ...
                    <select className="form-control" defaultValue={this.state.closeYear}
                        onChange={e => {
                            this.setState({ rosterReport: e.target.value })
                        }}>
                ...
                <div className='mt-3'>
                 ...
                 {rosterReport == 1 && <RosterDetailReport></RosterDetailReport>}
                 {/* {leaveReport == 2 && <AttendanceLateReport></AttendanceLateReport>}  */}
                {rosterReport == 2 && <RosterReport></RosterReport>}
            </div>
            </div>
        );
    }
