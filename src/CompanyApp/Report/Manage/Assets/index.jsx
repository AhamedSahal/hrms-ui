...
import AssetsReport from './CustomReport';
import AssetSummaryReport from './SummaryReport';
import AssetStatusReport from './StatusReport';

const { Header, Body, Footer, Dialog } = Modal;


export default class AssetsReportLanding extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                <div className="col-sm-4 col-md-4" style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    ...
                    <select className="form-control" defaultValue={this.state.closeYear}
                        onChange={e => {
                            this.setState({ assetsReport: e.target.value })
                        }}>
                ...
                {assetsReport == 1 && <AssetSummaryReport></AssetSummaryReport>}
                {assetsReport == 2 && <AssetStatusReport></AssetStatusReport>} 
                {assetsReport == 3 && <AssetsReport></AssetsReport>}
            </div>
            </div>
        );
    }
