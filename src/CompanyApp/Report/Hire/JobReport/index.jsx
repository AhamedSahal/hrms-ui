...
import HireReport from './Custom';
import JobStatusReport from './Status';
import JobSummaryReport from './Summary';

const { Header, Body, Footer, Dialog } = Modal;


export default class JobReportLanding extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="page-containerDocList content container-fluid" style={{marginTop: "20px"}}>
                ...
                <div className="col-sm-4 col-md-4" style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    ...
                    <select className="form-control" defaultValue={this.state.closeYear}
                        onChange={e => {
                            this.setState({ jobReport: e.target.value })
                        }}>
                ...
                <div className='mt-3'>
                 ...
                 {jobReport == 1 && <JobSummaryReport></JobSummaryReport>}
                 {jobReport == 2 && <JobStatusReport></JobStatusReport>}  
                {jobReport == 3 && <HireReport></HireReport>}
            </div>
            </div>
        );
    }
