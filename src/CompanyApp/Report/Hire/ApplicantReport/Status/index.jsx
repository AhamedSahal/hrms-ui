...
import PdfDocument from '../../../pdfDocument';
import { getApplicantReport } from '../service';
...
export default class ApplicantReport extends Component {
  constructor(props) {
    super(props);
    var today = new Date();
  ...
  fetchList = () => {
    if (verifyViewPermission("Applicant Report")) {
        getApplicantReport(this.state.q, this.state.fromDate, this.state.toDate > this.state.currentDate?this.state.currentDate:this.state.toDate,this.state.applicantType,this.state.selectedCompanies).then(response => {
  ...
  setAllChecked = (checkAll) => {
    ...
    let sortedData= []
     selectedProperties = ["applicantName","email","phoneNumber","jobProfile","appliedOn","sourceType","sourceName","noticePeriod","currentSalary","expectedSalary","workExperience","relevantExperience"];
        ...
        <div className="page-containerDocList content container-fluid" style={{ marginTop: "20px" }}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Applicant Status Report</h3>
                <ul hidden className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                  <li className="breadcrumb-item">Report</li>
                  <li className="breadcrumb-item active">Applicant Status Report</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="col-sm-6 col-md-3">
              <div className="form-group form-focus">
                  <select
                    ...
                    defaultValue={this.state.applicantType}
                    onChange={(e) => {
                  ...
                  >
                    ...
                    <option value="4">Dropouts</option>
                    <option value="5">Drafts</option>
                  </select>
              </div>
              </div>
                  ...
                  {selectedData && selectedData.length > 0 &&
                    <ButtonGroup>
                      <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                        exportToSortedCsvOrder(selectedData, "ApplicantStatus", "ApplicantStatus",selectedProperties)
                      }}>
