...
import { exportToSortedCsvOrder, getCompanyId, getMultiEntityCompanies, getTitle, toLocalTime, verifyViewPermission } from '../../../../../utility';
// import PdfDocument from '../../../pdfDocument';
import PdfDocument from '../../../pdfDocument';
import { getApplicantSummaryReport } from '../service';
...
export default class ApplicantSummaryReport extends Component {
  constructor(props) {
    super(props);
    var today = new Date();
  ...
  fetchList = () => {
    if (verifyViewPermission("Applicant Report")) {
        getApplicantSummaryReport(this.state.q, this.state.fromDate, this.state.toDate > this.state.currentDate?this.state.currentDate:this.state.toDate,this.state.selectedCompanies).then(response => {
  ...
  setAllChecked = (checkAll) => {
    ...
    let sortedData= []
     selectedProperties = ["jobCode","jobTitle","totalNewCount","totalScreeningCount","totalEvaluateCount","totalOfferedCount","totalHiredCount","totalDropoutsCount","totalDraftsCount","totalApplicants"];
  ...
  render() {
    ...
    return (
      ...
      <div className="insidePageDiv">
        <Helmet>
          <title>Applicant | {getTitle()}</title>
        ...
        <div className="page-containerDocList content container-fluid" style={{ marginTop: "20px" }}>
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Applicant Summary Report</h3>
                <ul hidden className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/app/main/dashboard">Dashboard</a></li>
                  <li className="breadcrumb-item">Report</li>
                  <li className="breadcrumb-item active">Applicant Summary Report</li>
                </ul>
              </div>
            </div>
          </div>
          {verifyViewPermission("Applicant Report") && <><div className="card p-2">
            <div className="row">
              <div className="col-sm-6 col-md-4">
                ...
                <div className="form-group form-focus">
                  ...
                  <label className="focus-label">Opening Date</label>
                </div>
              ...
              <div className="col-sm-6 col-md-4">
                <div className="form-group form-focus">
                  ...
                  <label className="focus-label">Expiry Date</label>
                </div>
                  ...
                  {selectedData && selectedData.length > 0 &&
                    <ButtonGroup>
                      <Button className='add-btn' variant='warning' size='sm' onClick={() => {
                        exportToSortedCsvOrder(selectedData, "ApplicantSummary", "ApplicantSummary",selectedProperties)
                      }}>
          ...
          {!verifyViewPermission("Applicant Report") && <AccessDenied></AccessDenied>}
        </div>
        {/* /Page Content */}
      </div>
    );
