...
import { BsFillCaretDownFill } from "react-icons/bs";
 import { getsubgoalsViewHistory } from './service';
...
export default class SubGoalsStatusViewHistory extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
      name: props.subgoalsViewHistory.name
  ...
  fetchList = () => {
    getsubgoalsViewHistory(this.props.subgoalsViewHistory.id).then(res => {
