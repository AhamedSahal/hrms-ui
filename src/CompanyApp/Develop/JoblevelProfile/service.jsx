...
const servicePath = "/job-profile";

export function getQualificationList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
...
export function getTrainingList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getTechnicalList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getLeadershipList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getBehaviouralList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getHonoursList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getLicenseList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getMembershipList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getLanguageList(employeeGrade) {
    let get=getWithAuth(`${servicePath}?&employeeGrade=${employeeGrade}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function saveMembership(membership) {
    console.log('cell ******111', membership)
