...
import { saveLeadershipCompetencies } from './service';
import { toast } from 'react-toastify';


export default class LeadershipCompetencies extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = (values, action) => {
        ...
        saveLeadershipCompetencies(leadershipData).then(res => {
            if (res.status == "OK") {
            ...
            toast.error("Error while saving Leadership Competencies form");
    ...
    render() {
        ...
        const data = [
            ...
            { snum: 3, field: 'Proficiency Rating', },
                ...
                {(formikProps) => {
                    ...
                    return (
                        <form onSubmit={formikProps.handleSubmit}>
                            ...
                            <input onClick={() => this.props.onClose('leadershipForm')} style={{ width: '73px' }} className="mt-3 m-3 float-right btn btn-primary" value={'Cancel'} />
                        </form>
                    )
                }}
            </Formik>
