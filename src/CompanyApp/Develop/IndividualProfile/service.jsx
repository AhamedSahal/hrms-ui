...
const servicePath = "/talent-profile";

export function getQualificationList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
...
export function getTrainingList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getTechnicalList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getLeadershipList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getBehaviouralList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getHonoursList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getLicenseList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getMembershipList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function getLanguageList(employeeId) {
    let get=getWithAuth(`${servicePath}?&employeeId=${employeeId}`)
    return get.then(res => {
        return Promise.resolve(res.data);
    }).catch(err => {
...
export function saveBehaviouralCompetencies(BehaviouralData) {
    console.log('cell ******', BehaviouralData)
    // let post = qualification.id == 0 ? postWithAuth(servicePath, qualification)
    //     : putWithAuth(`${servicePath}?id=${qualification.id}`, qualification);
    // return post.then(res => {
    //     return Promise.resolve(res.data);
...
export function saveMembership(membership) {
    console.log('cell ****** 222', membership)
