...
export default class ImpactofLoss extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div className="">
                ...
                <div className='threeBoxBody'>
                    <span style={{ fontSize: '18px', fontWeight: 700 }} className='ySide'>Impact Of Loss Rating</span>

                    <div style={{ height: '1em' }} className="nine-box-container">
                        <div style={{background: '#ADEDF9'}} className="threeBox quadrant-1"> <span className='boxHeader'>Low</span>
                            <div className='d-flex flex-wrap'>
                                {name.slice(0,1).map(item => (
                                    <>
                        ...
                        <div style={{background: '#2AE0E0'}} className="threeBox quadrant-2">
                        ...
                        <div style={{background: '#096A7C'}} className="threeBox quadrant-3"> <span className='boxHeader'>High</span>
                            <div className='d-flex flex-wrap'>
