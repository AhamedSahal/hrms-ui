...
export default class RiskofLoss extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div className="">
                <div className='threeBoxBody'>
                    <span style={{ fontSize: '18px', fontWeight: 700 }} className='ySide'>Risk Of Loss Rating</span>

                    <div style={{ height: '1em' }} className="nine-box-container">
                        <div style={{background: '#F49982'}} className="threeBox quadrant-1"> <span className='boxHeader'>Low</span>
                        ...
                        <div style={{background: '#FF643E'}} className="threeBox quadrant-2">
                        ...
                        <div style={{background: '#831E04'}} className="threeBox quadrant-3"> <span className='boxHeader'>High</span>
                            <div className='d-flex flex-wrap'>
                                {name.map(item => (
                                    <MeetingDashboardTooltip title={
                                        <div>
