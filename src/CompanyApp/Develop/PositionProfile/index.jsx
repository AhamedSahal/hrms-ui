...
export default class IndividualProfile extends Component {
    ...
    getProfileByJobtitle = (id) => {
        this.setState({ empJobtitle: id })
         // this.fetchList();
    }

    fetchList = () => {
        const { empJobtitle } = this.state
        getQualificationList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getTrainingList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getTechnicalList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getLeadershipList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getBehaviouralList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getHonoursList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getLicenseList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getMembershipList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
        ...
        getLanguageList(empJobtitle).then(res => {
            if (res.status == "OK") {
                this.setState({
    ...
    render() {
        const { isBodyVisible, formNames, empJobtitle, qualification, training, technical, leadership, behavioural, honours, license, membership, language } = this.state;
            ...
            <>
                <>
                    <div style={{ marginLeft: '60%' }} className=' mt-3 col-md-4'>
                        <label className='overtime-label'>Job Titles
                            <span style={{ color: "red" }}>*</span>
                        </label>
                        <JobTitlesDropdown defaultValue={0} onChange={e => {
                            this.getProfileByJobtitle(e.target.value)
                        }} ></JobTitlesDropdown>
                    </div>
                    {this.state.empJobtitle == '' && <div className="mt-3 p-3 alert alert-warning alert-dismissible fade show" role="alert">
                        <span>Please select Job Title to view Position Profile .</span>
                    </div>}
                </>
                {this.state.empJobtitle != '' &&
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.qualificationForm && (
                                <div className={`mt-2 profileFormBody ${formNames.qualification ? 'profileFormBodyVisible' : ''}`}>
                                    <QualificationForm empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></QualificationForm>
                                </div>
                            )}
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.trainingForm && (
                                <div className={`mt-2 profileFormBody ${formNames.training ? 'profileFormBodyVisible' : ''}`}>
                                    <TrainingCourse empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></TrainingCourse>
                                </div>
                            )}
                            {formNames.training &&
                                <>
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.behaviouralForm && (
                                <div className={`mt-2 profileFormBody ${formNames.behavioural ? 'profileFormBodyVisible' : ''}`}>
                                    <BehaviouralCompetencies empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></BehaviouralCompetencies>
                                </div>
                            )}
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.leadershipForm && (
                                <div className={`mt-2 profileFormBody ${formNames.leadership ? 'profileFormBodyVisible' : ''}`}>
                                    <LeadershipCompetencies empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></LeadershipCompetencies>
                                </div>
                            )}
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.technicalForm && (
                                <div className={`mt-2 profileFormBody ${formNames.technical ? 'profileFormBodyVisible' : ''}`}>
                                    <TechnicalCompetencies empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></TechnicalCompetencies>
                                </div>
                            )}
                            {formNames.technical &&
                                <>
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.honoursForm && (
                                <div className={`mt-2 profileFormBody ${formNames.honours ? 'profileFormBodyVisible' : ''}`}>
                                    <HonoursAndAward empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></HonoursAndAward>
                                </div>
                            )}
                            {formNames.honours &&
                                <>
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.licenseForm && (
                                <div className={`mt-2 profileFormBody ${formNames.license ? 'profileFormBodyVisible' : ''}`}>
                                    <LicenseAndCertificate empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></LicenseAndCertificate>
                                </div>
                            )}
                            {formNames.license &&
                                <>
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.membershipForm && (
                                <div className={`mt-2 profileFormBody ${formNames.membership ? 'profileFormBodyVisible' : ''}`}>
                                    <Membership empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></Membership>
                                </div>
                            )}
                        ...
                        <div className='profileFormHead' >
                            ...
                            {formNames.language && (
                                <div className={`mt-2 profileFormBody ${formNames.language ? 'profileFormBodyVisible' : ''}`}>
                                    <Language empJobtitle={this.state.empJobtitle} onClose={this.closeForm}></Language>
                                </div>
                            )}
