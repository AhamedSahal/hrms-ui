...
import { deleteSurvey, getDraftList, getTemplateList } from './service';
...
export default class Template extends Component {
  ...
  fetchList = () => {
    ...
    getTemplateList(this.state.q, this.state.page, this.state.size, this.state.sort).then(res => {
      if (res.status == "OK") {
        this.setState({
          data: res.data.list,
        ...
        <div className="page-container content container-fluid">
          ...
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                {getUserType() == 'SUPER_ADMIN' ? (<h3 className="tablePage-title">Survey Template</h3>)
              ...
              <div className="float-right d-flex col-auto mt-2">
                ...
                {getUserType() === 'SUPER_ADMIN' && <div className="col-md-6 btn-group">
                  <Link className="btn apply-button btn-primary" to={`manage-survey/manage`}>
