...
import OffboardMSchecklistForm from './checklistForm';
...
export default class OffboardingMSCheckList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: tasks || [],
    ...
    fetchList = () => {
        // getOffboardMSCheckList(this.state.q, this.state.page, this.state.size, this.state.sort).then(res => {
        //     if (res.status == "OK") {
        //       this.setState({
        //         data: res.data.list,
        ...
        return (
            <div >
                        ...
                        <div style={{ height: '80px' }} className="goalHeader-container">
                            <div className="onboardTaskHead-section">
                                ...
                                <div className="mt-2 float-right col-auto ml-auto">
                                    {verifyOrgLevelEditPermission("Module Setup Offboard") && 
                                    <button onClick={() => {
                                        this.setState({
                                            showForm: true
                                        })
                ...
                <Modal enforceFocus={false} size={"md"} show={this.state.showForm} onHide={this.hideForm}>
                    ...
                    <Body>
                        <OffboardMSchecklistForm updateList={this.updateList} checklist={this.state.checklist} >
                        </OffboardMSchecklistForm>
                    </Body>
                </Modal>
            </div>
        );
