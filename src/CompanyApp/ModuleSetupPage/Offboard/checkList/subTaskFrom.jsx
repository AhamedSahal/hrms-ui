...
class OffboardSubTaskForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            function: [],
    ...
    save = (data, action) => {
        ...
        // saveOffboardMSSubTask(subtask).then(res => {
        //     if (res.status === "OK") {
                        ...
                        <Form autoComplete='off'>
                            ...
                            <FormGroup>
                                ...
                                <div className='d-flex mb-2' name="dueOn" onChange={(e) => {
                                    ...
                                    <Field className='mr-1' type="radio" value="1" name="dueOn" /> Before LWD
                                    <Field className='ml-4 mr-1' type="radio" value="2" name="dueOn" /> After LWD
                                    <Field className='ml-4 mr-1' type="radio" value="3" name="dueOn" /> Date of LWD
                                </div>
...
export default OffboardSubTaskForm;