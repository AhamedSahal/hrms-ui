...
const servicePath = "/Offboard-list";
...
export function getOffboardChecklist(departmentId,branchId, searchText,jobTitleId, pageNumber, pageSize,q, sort, fromDate, toDate) {
