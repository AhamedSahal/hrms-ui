...
export default class WEAddedtopayroll extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const menuItems = (text, record) => {
            ...
            if (isCompanyAdmin && record.isPaid == 1) {
                items.push(<div>
                    <a className="muiMenu_item" href="#"
                        onClick={() => {
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (text, record) => {
                    return <>
                        <div>{record.amountspent != null ? record.amountspent : "NA"}</div>
                    </>
                }
            ...
            },
            {
                ...
                render: (text, record) => {
                    return <>
                        <div>{record.isPaid == 0 ? "Not Paid" : record.isPaid == 1 ? "In Progress" : "-"}</div>
                    </>
                  }
