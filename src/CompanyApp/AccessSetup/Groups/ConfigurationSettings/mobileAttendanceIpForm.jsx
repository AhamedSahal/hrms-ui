...
import { addMobileIPsIntoGroup, getMobileIPsList } from './service';


export default class MobileAttendanceIPForm extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    fetchIPList = () => {
        ...
        getMobileIPsList(groupId, attendanceConfigurationId).then(res => {
            if (res.status == "OK") {
                this.setState({
                    ipList: res.data,
                })
    ...
    save = () => {
        ...
        addMobileIPsIntoGroup(data).then(res => {
            if (res.status == "OK") {
