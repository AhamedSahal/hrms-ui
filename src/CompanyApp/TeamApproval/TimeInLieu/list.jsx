...
import TimeInLieuction from './timeInLieuction';
import { getTeamEntitlementTimeinlieuList, updateSelectedStatus } from './service';
...
export default class TimeinlieuApproval extends Component {
  constructor(props) {
    super(props);
    var today = new Date();
  ...
  updateList = (timeinlieu) => {
    ...
    if (index > -1)
      ...
      data.push(timeinlieu);
    }
    this.setState({ data },
      () => {
        this.hideTimInLieuAction();
      });
  }

  hideTimInLieuAction = () => {
    this.setState({
      showTimeInLieuAction: false,
  ...
  render() {
              ...
              <div className="dropdow">
                ...
                <div className="dropdown-menu dropdown-menu-right">
                  <a className="dropdown-item" href="#" onClick={() => {
                    let { timeinlieu } = this.state;
                    timeinlieu = text;
                    this.setState({ timeinlieu, showTimeInLieuAction: true, })
                  }}>
                    <i className="las la-check-double m-r-5"></i> Time In Lieu Action</a>
                </div>
              </div>
            </Col>
          </Row>
    ...
    return (
      ...
      <div className="">
        <Helmet>
          <title>Time In Lieu  | {getTitle()}</title>
          <meta name="description" content="Timeinlieu page" />
        </Helmet>
        {/* Page Content */}
          {/* Page Header */}
          ...
          <Modal enforceFocus={false} size={"md"} show={this.state.showTimeInLieuAction} onHide={this.hideTimInLieuAction} >


            <Header closeButton>
              <h5 className="modal-title">Time In Lieu</h5>
            </Header>
            <Body>
              <TimeInLieuction updateList={this.updateList} timeinlieu={this.state.timeinlieu}>
              </TimeInLieuction>
            </Body>
