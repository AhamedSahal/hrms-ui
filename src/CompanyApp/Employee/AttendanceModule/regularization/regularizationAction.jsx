...
import { convertToUserTimeZone, toDateTime, getReadableDate, convertToUTC,toLocalDateTime } from '../../../../utility';
                ...
                {regularize &&
                    ...
                    <><table className="table">
                        ...
                        <tr>
                            ...
                            <td>{toLocalDateTime(regularize.regularizedInTime)}</td>
                        </tr>
                        <tr>
                            <th>Requested Clock-Out Time</th>
                            <td>{toLocalDateTime(regularize.regularizedOutTime)}</td>
                        </tr>
                        <tr>
