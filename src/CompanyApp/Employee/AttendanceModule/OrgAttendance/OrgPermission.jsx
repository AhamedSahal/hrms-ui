...
import 'react-confirm-alert/src/react-confirm-alert.css'
import { getUserType, getEmployeeId, verifyViewPermission, getCustomizedWidgetDate, verifyOrgLevelEditPermission, verifyApprovalPermission } from '../../../../utility';
import { itemRender } from '../../../../paginationfunction';
import { getOvertimeList } from '../Overtime/service';
import { Button } from '@mui/material';
import { ButtonGroup, Modal } from 'react-bootstrap';
import PermissionForm from '../Permission/form';
import { deleteReqPermission, getReqPermissionList } from '../Permission/service';
import { confirmAlert } from 'react-confirm-alert';
import { toast } from 'react-toastify';
import PermissionAction from '../Permission/actionForm';
...
export default class TeamPermission extends Component {
  constructor(props) {
    super(props);
      ...
      },
      {
        ...
        render: (text, record) => (
          ...
          <div className="dropdow">
            {verifyOrgLevelEditPermission("ATTENDANCE") && <><a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              ...
              {record.status === 'PENDING' && <div className="dropdown-menu dropdown-menu-right">
                ...
                <a className="dropdown-item" href="#" onClick={() => {
                  ...
                  this.setState({ permission: text, showPermissionAction: true, showForm: false })
                }} >
                  <i className="las la-check-double m-r-5"></i> Permission Action</a>
              </div>}</>}
          </div>
        ),
      },
    ...
    return (
      <>
              ...
              <div className="form-group p-12 m-0 pb-2">
                <div className="row " >
                  <div className="mt-3 col">
                    <h3 className="page-titleText">Org Request Permission</h3>
                  </div>
        ...
        <Modal enforceFocus={false} size={"md"} show={this.state.showForm} onHide={this.hideForm} >
          ...
          <Body>
            <PermissionForm updateList={this.updateList} permission={this.state.permission} />
          </Body>
        </Modal>
        <Modal enforceFocus={false} size={"md"} show={this.state.showPermissionAction} onHide={this.hidePermissionAction} >
          <Header closeButton>
            <h5 className="modal-title">Permission Action</h5>
          </Header>
          <Body>
            <PermissionAction showAlert={this.showAlert} updateList={this.updateList} permission={this.state.permission} employeeId={this.state.employeeId}>
            </PermissionAction>
          </Body>
        </Modal>
      </>
