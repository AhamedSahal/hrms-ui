...
export default class OrgWeeklyListViewCalendar extends Component {
    state = {
    ...
    fetchList = () => {
        // getOrgEmployeeWeeklyCalenderList(this.state.employeeId ,this.state.branchId, this.state.departmentId, this.state.fromDate, this.state.toDate).then(res => {
        //         if (res.status == "OK") {
        //             this.setState({
        //                 data: res.data.list,
        //             })
