...
import { convertToUserTimeZoneForAttendance, getUserType, verifyApprovalPermission, verifyViewPermission } from '../../../../utility';
...
export default class TeamAttendanceList extends Component {
    constructor(props) {
        super(props);
        var today = new Date();
