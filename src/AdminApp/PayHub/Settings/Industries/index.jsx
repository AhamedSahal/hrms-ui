...
const datas = [{ id: 0, name: 'Oil and Gas', active: true },
{ id: 1, name: 'Hospitality', active: false }, { id: 1, name: 'Real Estate', active: true },
{ id: 1, name: 'Construction', active: true }]
...
export default class Industry extends Component {
  ...
  //   }
  //   fetchList = () => {
  //       getRegionList(this.state.q, this.state.page, this.state.size, this.state.sort).then(res => {
  //         if (res.status == "OK") {
  //           this.setState({
  //             data: res.data.list,
  ...
  updateList = (industry) => {
    let { data } = this.state;
    let index = data.findIndex(d => d.id == industry.id);
    if (index > -1)
      data[index] = industry;
    else {
      data = [industry, ...data];
  ...
  delete = (industry) => {
    confirmAlert({
      title: `Delete Industry ${industry.name}`,
      message: 'Are you sure, you want to delete this Industry?',
      buttons: [
        {
          label: 'Yes',
          //   onClick: () => deleteRegion(industry.id).then(res => {
          //     if (res.status == "OK") {
            ...
            <><a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <a className="dropdown-item" href="#" onClick={() => {
                  this.setState({ industry: text, showForm: true })
                }} >
        ...
        <div className="page-container content container-fluid">
          ...
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Industries</h3>
              </div>
          ...
          <Modal enforceFocus={false} size={"md"} show={this.state.showForm} onHide={this.hideForm} >
            <Header closeButton>
              <h5 className="modal-title">{this.state.industry ? 'Edit' : 'Add'} Industry</h5>
            </Header>
            <Body>
              <RegionForm updateList={this.updateList} industry={this.state.industry}>
              </RegionForm>
            </Body>
          </Modal>
        </div>
