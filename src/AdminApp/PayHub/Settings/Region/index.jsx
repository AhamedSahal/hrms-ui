...
import { deleteRegion } from './service';
import { toast } from 'react-toastify';

const datas = [{id:0 , name: 'UAE', active: true},{id:1 , name: 'Oman', active: true},
{id:1 , name: 'Qatar', active: true},{id:1 , name: 'Bahrain', active: false}]
...
//   }
  ...
  updateList = (region) => {
    let { data } = this.state;
    let index = data.findIndex(d => d.id == region.id);
    if (index > -1)
      data[index] = region;
    else {
      data = [region, ...data];
  ...
  delete = (region) => {
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => deleteRegion(region.id).then(res => {
            if (res.status == "OK") {
        ...
        <div className="page-container content container-fluid">
          ...
          <div className="tablePage-header">
            <div className="row pageTitle-section">
              <div className="col">
                <h3 className="tablePage-title">Region</h3>
              </div>
          ...
          <Modal enforceFocus={false} size={"md"} show={this.state.showForm} onHide={this.hideForm} >
            ...
            <Body>
              <RegionForm updateList={this.updateList} region={this.state.region}>
              </RegionForm>
            </Body>
          </Modal>
        </div>
